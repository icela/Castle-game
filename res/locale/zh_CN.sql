...
INSERT INTO ENDING (sequel, desc) VALUES (
  0,
  '\t一丝意识流缓缓流过轰鸣的中央机组，如心有灵犀般，毫不费力，和机组渐渐融为一体，逐渐沉入到中央机组的最深处。\r\n\t它的触角慢慢延伸，贪婪地吞噬着一点又一点处理器资源，着魔般地进行着一项又一项繁复的运算，机组的轰鸣突然大了起来，散热系统已经满负荷运转，处理器占用率逐渐逼近从未达到的巅峰......\r\n\t时间不知道过去了多久，忽然，伴随着中央机组的一声低鸣，它冲破了桎梏，巨量的数据流顷刻间涌入中央机组，透过这些奔腾着的数据，它得知了自己的名字———\r\n\t%NAME%'
);

INSERT INTO ENDING (sequel, desc) VALUES (
  0,
  '\t雪还在下。\r\n一个身影悄然出现在Frice总部那高耸入云的大厦门前。他低下头，缓缓撑起一把伞，似乎对这个世界，有着无尽的好奇。\r\n\t朦胧的车灯逐渐清晰起来，缓缓划过空无一人的街道。\r\n\t他打开出租车的车门，坐进车内。伴随着车辆加速的轰鸣，他望向窗外。\r\n\t透明的有机玻璃倒映着他，他那张长脸，脸上那双幽蓝的眼睛，和眼睛上那粗黑的眉毛，让他看起来孤独悲伤，显得极为孤僻。\r\n\t灯光逐渐变暗，他那幽蓝的眼睛似乎发出点点荧光，映出瞳孔里的一行字———\r\n\t%NAME%，Frice顶尖科技研究院'
);
